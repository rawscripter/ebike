                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            <div class="card-body">
                                {!! Form::open(['action' => 'OwnerController@store','id'=>'owner_form']) !!}
                                <div class="row">
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::textarea('present_address', null, ['class' => 'form-control present_address','rows'=>'4'])}}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            Present Address)
                                            {{ Form::textarea('permanent_address', null, ['class' => 'form-control permanent_address','rows'=>'4'])}}
                                        </div>
                                    </div>
